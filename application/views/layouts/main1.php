...
<div class="wrapper">
    <header class="main-header">
        ...
        <a href="" class="logo">
            ...
            <span class="logo-mini">e-रसिद</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg">e-रसिद </span>
        </a>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="<?php echo site_url('./images/userimages/'.$users['Photo']);?>" class="img-circle" alt="User Image">
			   </div>
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li>
                            <a href="<?php echo site_url('customer/index');?>"><i class="fa fa-list-ul"></i> List</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li>
                            <a href="<?php echo site_url('invoice/index');?>"><i class="fa fa-list-ul"></i> List</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li>
                            <a href="<?php echo site_url('product/index');?>"><i class="fa fa-list-ul"></i> List</a>
                        </li>
                    </ul>
